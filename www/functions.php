...
?>
<div class="btn-group" >
  <button  name="viewfull"  type="button" class="btn btn-primary ">Развернуть список</button>
...
// конец сборки	
	...
	foreach ($sections as $num => $val) 
	{
		...
		{	
			...
			echo  $tree.'&nbsp;'.$sections[$num]['name'].' (Блюд: '.$sections[$num]['dishes'].') '.chr(10);
